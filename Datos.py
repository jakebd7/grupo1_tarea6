...
if cursos_min_programa <= Programa.id_programa <= cursos_max_programa:
    if estudiante_min_programa <= Estudiante.id <= estudiante_max_programa:
        ...
        print(matricula1, estudiante1, programa_python, curso_python_1, curso_python_2)  # Insercion 4
        print(matricula1, estudiante1, programa_java, curso_java_1, curso_java_2)  # Insercion 5
    else:
