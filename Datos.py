...
"""Agregando Profesores y sus Cursos"""
...
if cursos_min_programa <= Programa.id_programa <= cursos_max_programa:
    if estudiante_min_programa <= Estudiante.id <= estudiante_max_programa:
        ...
        print(matricula3, estudiante3, programa_java, curso_java_1, curso_java_2, profesor_curso_java)  # Insercion 3
        ...
        print(matricula1, estudiante1, programa_java, curso_java_1, curso_java_2, profesor_curso_java)  # Insercion 5
    else:
        print("Error en la cantidad de Programas para un Estudiuante")
else:
    print("Error en la cantidad de programas Registrados")
